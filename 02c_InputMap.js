...
var _MAP_BESS_S6 = {
  ...
  bessCablePath:             { sheet: SH.INPUT_BESS, row: 48, col: 3, label: 'Trayectoria del cable',                  type: 'dropdown', default: '', seed: 'CONDUIT_ENTERRADO', dropdown: ['INTEMPERIE', 'CONDUIT_ENTERRADO', 'BANDEJA_INTERIOR'], helpText: 'INTEMPERIE = exterior con PVC/RGS; CONDUIT_ENTERRADO = PVC sched 80 enterrado; BANDEJA_INTERIOR = cable tray interior.', section: 'BESS 6 DISTANCIAS', consumedBy: ['engine'] },
  ...
  bessGroundingSystem:       { sheet: SH.INPUT_BESS, row: 51, col: 3, label: 'Sistema de tierra',                      type: 'dropdown', default: '', seed: 'VARILLA', dropdown: ['UFER', 'VARILLA', 'RED_EXISTENTE'], helpText: 'UFER = electrodo en concreto; VARILLA = barra cobre; RED_EXISTENTE = malla del sitio.',                  section: 'BESS 6 DISTANCIAS', consumedBy: ['engine'] },
